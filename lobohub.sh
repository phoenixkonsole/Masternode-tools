...
version=$(curl https://raw.githubusercontent.com/Lagadsz/Masternode-tools/master/current)
link=$(curl https://raw.githubusercontent.com/Lagadsz/Masternode-tools/master/download)
PORT=22123
RPCPORTT=22130
